...
// import { LoginPasswordContext } from './AuthStack';
...
function Login({ navigation }: AuthNavProps<"Login">) {
    const { login,email,password,testloginmessage /*,setEmail,setPassword*/ } = useContext(AuthContext);
    ...
    // const [loginEmail,setLoginEmail] = useState("")
    // const [loginPassword,setLoginPassword] = useState("")
    const {loginEmail,setLoginEmail,loginPassword,setLoginPassword} = useContext(LoginPasswordContext);
    ...
    return (
      ...
      <Center>
        ...
        />
        <Button title="Test login via api" onPress={() => login()} color="purple"/>
